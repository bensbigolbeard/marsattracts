...
Ship.find(1).flights.create!([
    ...
    duration: 56, 
    departure_time: Date.today + 34.years, 
    arrival_time: Date.today + 34.years + 56.months, 
    origin_id: 3, 
    destination_id: 5,
    price: 12099, 
    distance: "a million units"},
    ...
    duration: 23, 
    departure_time: Date.today + 34.years, 
    arrival_time: Date.today + 34.years + 23.months, 
    origin_id: 3, 
    destination_id: 5,
    price: 19999, 
    distance: "a million units"},
    ...
    duration: 47, 
    departure_time: Date.today + 34.years, 
    arrival_time: Date.today + 34.years + 47.months, 
    origin_id: 4, 
    destination_id: 5,
    price: 15999, 
    distance: "a million units"},
    ...
    duration: 70, 
    departure_time: Date.today + 34.years, 
    arrival_time: Date.today + 34.years + 70.months, 
    origin_id: 1, 
    destination_id: 3,
    price: 9999, 
    distance: "a million units"},
    ...
    duration: 20, 
    departure_time: Date.today + 15.years, 
    arrival_time: Date.today + 15.years + 20.months, 
    origin_id: 2, 
    destination_id: 3,
    price: 7500, 
    distance: "two million units"}, 
    ...
    duration: 16, 
    departure_time: Date.today + 15.years, 
    arrival_time: Date.today + 15.years + 16.months, 
    origin_id: 3, 
    destination_id: 2,
    price: 9500, 
    distance: "two million units"},
    ...
    duration: 26, 
    departure_time: Date.today + 15.years, 
    arrival_time: Date.today + 15.years + 26.months, 
    origin_id: 1, 
    destination_id: 4,
    price: 18000, 
    distance: "two million units"},
    ...
    duration: 18, 
    departure_time: Date.today + 15.years, 
    arrival_time: Date.today + 15.years + 18.months, 
    origin_id: 1, 
    destination_id: 4,
    price: 15000, 
    distance: "two million units"}
...
Ship.find(2).flights.create!([
    ...
    duration: 19, 
    departure_time: Date.today + 25.years, 
    arrival_time: Date.today + 25.years + 19.months, 
    origin_id: 2, 
    destination_id: 3,
    price: 50000, 
    distance: "a million units"},
    ...
    {flight_number:'012', 
    departure_time: Date.today + 12.years,
    arrival_time: Date.today + 12.years + 19.months,
    duration: 19, 
    origin_id: 2, 
    destination_id: 5,
    price: 75000, 
...
Ship.find(3).flights.create!([
    ...
    {flight_number:'095', 
    departure_time: Date.today + 40.years, 
    arrival_time: Date.today + 40.years + 6.months,
    duration: 6, 
    origin_id: 1, 
    destination_id: 1,
    price: 500000, 
